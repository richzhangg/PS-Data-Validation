...
def compare_files(a_path, b_path, a_col, b_col):
    ...
    print("PASS_WITH_ERRORS")
    print(f"source column: {a_label}.{a_col}")
    print(f"D365 column: {b_label}.{b_col}")
...
#b - d365
compare_files(
    a_path=r"C:\Users\rzhang\OneDrive - Pacific Sunwear of California, Inc\validation 122625\wholesale\Factories_Wholesale_122625.xlsx",
    b_path=r"C:\Users\rzhang\OneDrive - Pacific Sunwear of California, Inc\validation 122625\d365 validation files\factorieswholesale_d365.xlsx",
    a_col="factory",
    b_col="factoryname"
)
