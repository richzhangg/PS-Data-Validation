...
def compare_files(a_path, b_path, a_col, b_col):
    ...
    print(f"Unique values A={len(a_set)}, B={len(b_set)}")
...
#b - d365
compare_files(
    a_path=r"C:\Users\rzhang\OneDrive - Pacific Sunwear of California, Inc\validation 122625\InforVendors_20251226.csv",
    b_path=r"C:\Users\rzhang\OneDrive - Pacific Sunwear of California, Inc\validation 122625\d365 validation files\vendoraddresses_d365.xlsx",
    a_col="VendorAddressLine1",
    b_col="PACSTREET1"
)
